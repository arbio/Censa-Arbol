...
TreeRecord.prototype.updateUtm = function updateUtm() {
    ...
    tag.refs.utm_south.value = (utmCoords.isSouthern) ? "S" : "N";
};
if (!TreeRecord.prototype.updateUtm.__argnames__) Object.defineProperties(TreeRecord.prototype.updateUtm, {
    __argnames__ : {value: []}
});
TreeRecord.prototype.updateLatLong = function updateLatLong() {
    var self = this;
    var utmCoords, llCoords;
    utmCoords = (function(){
        var ρσ_d = {};
        ρσ_d["coord"] = (function(){
            var ρσ_d = {};
            ρσ_d["x"] = tag.refs.utm_x.value;
            ρσ_d["y"] = tag.refs.utm_y.value;
            return ρσ_d;
        }).call(this);
        ρσ_d["zone"] = tag.refs.utm_zone.value;
        ρσ_d["isSouthern"] = ((tag.refs.utm_south.value === "S" || typeof tag.refs.utm_south.value === "object" && ρσ_equals(tag.refs.utm_south.value, "S"))) ? true : false;
        return ρσ_d;
    }).call(this);
...
if (!TreeRecord.prototype.updateLatLong.__argnames__) Object.defineProperties(TreeRecord.prototype.updateLatLong, {
    __argnames__ : {value: []}
});
...
function getFormValues(tree) {
    ...
    tree.data["lat"] = str(tag.refs.lat.value || 0);
    tree.data["long"] = str(tag.refs.long.value || 0);
    tree.data["utm_x"] = str(tag.refs.utm_x.value || 0);
    tree.data["utm_y"] = str(tag.refs.utm_y.value || 0);
    tree.data["utm_zone"] = str(tag.refs.utm_zone.value || 0);
    tree.data["utm_south"] = str(tag.refs.utm_south.value || "");
